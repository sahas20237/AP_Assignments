...
class SquareMatrix extends Matrix{ // Square matrix inherits from Rectangular matrix
    private int side;
    private double determinant; // determinant can be created only of Square matrix

    private double findDeterminant(ArrayList<ArrayList<Double>> A){
        double det = -1.0;
    ...
    public SquareMatrix(ArrayList<ArrayList<Double>> matrix, int row, int col, ArrayList<String> type, int matrixID){
        ...
        this.determinant = findDeterminant(matrix);
    }
...
class matrixMain{
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i<num; i++){
            ...
            // combiantion of matrixGenerator(), typeGiver() and memoryOptimizer() is the basis of my code
